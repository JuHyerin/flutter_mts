...
/*Future<void> storeTokens() async {
  final StockApi api = StockApi.init();
  String oauthToken = await api.getOauthToken();
  String socketToken = await api.getSocketAccessToken();

  Get.put(TokenController(oauthToken: oauthToken, socketAccessToken: socketToken));
}*/
...
Future<void> main() async {
  ...
  Get.put(StockDataController.forTest(
    '005930^123501^62100^5^-1600^-2.56^61501.31^62500^62500^60900^61000^60900^10^7525074^462801972700^11825^29231^17406^50.66^4811780^2437537^1^0.33^45.25^090004^5^-1500^090004^5^-1500^123323^2^100^20221202^20^N^228235^100806^797127^1735492^0.13^11018503^68.29^0^^62500^005930^123501^60900^5^-1700^-2.72^61501.31^62500^62500^60900^61000^60900^2^7525076^462802094500^11826^29231^17405^50.66^4811782^2437537^5^0.33^45.25^090004^5^-1600^090004^5^-1600^123323^3^0^20221202^20^N^228225^100814^797117^1735510^0.13^11018503^68.29^0^^62500'
  ),tag: 'H0STCNT0_005930');*/

  await api.getSocketAccessToken();
